...
class rpcbind (
  ...
  } elsif $facts['os']['name'] == 'Ubuntu' and !($facts['os']['release']['major'] in ['14.04','16.04','18.04','20.04']) {
    fail("Ubuntu's os.release.major is <${facts['os']['release']['major']}> and must be 14.04, 16.04, 18.04 or 20.04")
  }
